...
| Branch | `anima` |
| HEAD (at writing) | `e269834` · 372 commits |
...
| Verify everything | `python3 scripts/run_master_cert_stack.py` (74/74 GREEN) then `python3 scripts/run_diamond_v2.py --gate` (Diamond CONFIRMED) |
| Size | 343 Python modules · 210 cert scripts · 36 web surfaces · 93 reports |
...
3. `python3 scripts/run_master_cert_stack.py` to confirm 74/74 GREEN, then `run_diamond_v2.py --gate`.
