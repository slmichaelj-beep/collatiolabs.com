...
flowchart TD
  User["Human"]
  Vera["Base Vera: Portable Private Personality"]
  Memory["Private Memory OS"]
  Privacy["Privacy / Consent / Egress Gate"]
  Router["Task + Model Router"]
  Local["Local Models"]
  Cloud["Optional Cloud Cognition"]
  Tools["Tools + Connectors"]
  Verify["Verifier / Honesty Rail"]
  Gov["Governance / Authority / Receipts"]
  Kits["Add-On Kits"]
  Output["Vera Voice + Action Plan"]
...
- company-operator, self-evolution approval binding, and budget invariants certified; marketplace resource invariants remain on the hardening queue
...
- Add finite-state workflow guards.
